...
<?php 
/* some questions that are unsolved on this script 
how to show the selected options after submission with 
valid user input for Gender, Hobbies, Bio.
Another problem is, how to show the given value on the same 
page or on another page after submit 
without lossing the current page output */
?>